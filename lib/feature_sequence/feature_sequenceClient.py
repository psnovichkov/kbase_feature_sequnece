...
class feature_sequence(object):
    ...
    def featureset_protein_sequence(self, workspace_name, featureset_id, json_rpc_context = None):
        if json_rpc_context and type(json_rpc_context) is not dict:
            raise ValueError('Method featureset_protein_sequence: argument json_rpc_context is not type dict as required.')
